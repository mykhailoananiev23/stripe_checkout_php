      ...
      <div class="container">
        <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background: url(img/hero-banner-alt.jpg)">
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                <p class="text-muted small text-uppercase mb-2">Featured Offer</p>
                <h1 class="h2 text-uppercase mb-3">Dual home speaker and clock with magic balance</h1>
                <a class="btn" style="background-color:#2D76E9;color:#fff;" href="browse-offers.php">View details ></a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="pt-5">
          <header class="text-center">
            <p class="small text-muted small text-uppercase mb-1"><i class="fa-solid fa-box-open"></i> Just Added</p>
            <h2 class="h5 text-uppercase mb-4">Browse the latest offers</h2>
          </header>
<div class="row">
            <!-- PRODUCT-->
        ...
        <!-- ABOUT TO EXPIRE OFFERS-->
        <section class="py-5">
          <header>
            <p class="small text-muted small text-uppercase mb-1"><i class="fa-solid fa-clock"></i> Leaving soon</p>
            <h2 class="h5 text-uppercase mb-4">These offers are about to expire</h2>
          </header>
          <div class="row">
            <!-- PRODUCT-->
            <div class="col-xl-3 col-lg-4 col-sm-6">
        ...
        <section class="py-5">
          <div class="container p-0">
            <div class="row gy-3">
              <div class="col-lg-6">
                <h5 class="text-uppercase">Create a seller account</h5>
                <p class="text-sm text-muted mb-0">List your own products in just a few minutes!</p>
              </div>
              <div class="col-lg-6">
                <form action="#">
                  <div class="input-group">
                    ...
                    <button class="btn" id="button-addon2" type="submit" style="background-color:#2D76E9;color:#fff;">Sign up</button>
                  </div>
                </form>
              </div>
            </div>
