                ...
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4 gx-0">
                      <div class="col-sm-5"><a class="btn btn-sm w-100 h-100 d-flex align-items-center justify-content-center px-0 text-uppercase" style="background-color:#2D76E9;color:#fff;" href="cart.html"><b>Contact seller</b></a></div>
                    </div><a class="btn btn-link text-dark text-decoration-none p-0" href="#!"><i class="far fa-heart me-2"></i>Save to my favorites</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-5">
            ...
            <div class="col-lg-6">
              ...
              <div class="row align-items-stretch mb-4">
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0 text-uppercase" style="background-color:#2D76E9;color:#fff;" href="cart.html"><b>Contact seller</b></a></div>
              </div><a class="text-dark p-0 mb-4 d-inline-block" href="#!"><i class="far fa-heart me-2"></i>Add to favorites</a><br>
              <ul class="list-unstyled small d-inline-block">
              <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase"><h5>Asking price:</strong><span class="ms-2 text-muted">$4.50</span></h5></li>
                <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase"><h5>Available:</strong><span class="ms-2 text-muted">440</span></h5></li>
                <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase"><h5>Stored at:</strong><span class="ms-2 text-muted">Amazon warehouse (US)</span></h5></li>
              </ul>
            </div>
          </div>
          <!-- DETAILS TABS-->
          <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link text-uppercase active" id="description-tab" data-bs-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true" style="background-color:#2D76E9;color:#fff;">Description</a></li>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                <h6 class="text-uppercase">Offer description </h6>
