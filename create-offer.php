        ...
        <section class="py-5 bg-light">
          <div class="container">
            <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
              <div class="col-lg-6">
                <h1 class="h2 text-uppercase mb-0">Create your offer</h1>
              </div>
          ...
          <div class="row">
            <div class="col-lg-8">
              <form action="#">
                <div class="row gy-3">
                  <div class="col-lg">
                    <label class="form-label text-sm text-uppercase" for="productname">Product name </label>
                    <input class="form-control form-control-lg" type="text" name="productname" id="productname">
                  </div>
                  <div class="col-lg-4 offset-lg-8">
                    <label class="form-label text-sm text-uppercase" for="quantity">Quantity available </label>
                    <input class="form-control form-control-lg" type="number" name="quantity" id="quantity">
                  </div>
                  <div class="col-lg-4">
                    <label class="form-label text-sm text-uppercase" for="asking_price"> </label>
                    <input class="form-control form-control-lg" type="number" name="asking_price" id="asking_price">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="company">Current location (select all that apply) </label>
